...
" Author:   Jindrich Kralevic Smitka <smitka.j AT gmail DOT com>
" Homepage: https://github.com/s-m-i-t-a/vim-python-syntax
"
" Based on https://github.com/python-mode/python-mode syntax file


" DESC: Disable script loading
if exists('g:python_syntax') || &cp
  finish
endif
let g:python_syntax = 1
...
call s:InitVariable('g:python_syntax_all', 1)

" Highlight 'print' as function
call s:InitVariable("g:python_syntax_print_as_function", 0)
"
" Highlight 'async/await' keywords
call s:InitVariable("g:python_syntax_highlight_async_await", g:python_syntax_all)

" Highlight '=' operator
call s:InitVariable('g:python_syntax_highlight_equal_operator', g:python_syntax_all)

" Highlight '*' operator
call s:InitVariable('g:python_syntax_highlight_stars_operator', g:python_syntax_all)

" Highlight 'self' keyword
call s:InitVariable('g:python_syntax_highlight_self', g:python_syntax_all)

" Highlight indent's errors
call s:InitVariable('g:python_syntax_indent_errors', g:python_syntax_all)

" Highlight space's errors
call s:InitVariable('g:python_syntax_space_errors', g:python_syntax_all)

" Highlight string formatting
call s:InitVariable('g:python_syntax_string_formatting', g:python_syntax_all)
call s:InitVariable('g:python_syntax_string_format', g:python_syntax_all)
call s:InitVariable('g:python_syntax_string_templates', g:python_syntax_all)
call s:InitVariable('g:python_syntax_doctests', g:python_syntax_all)

" Support docstrings in syntax highlighting
call s:InitVariable('g:python_syntax_docstrings', 1)

" Highlight builtin objects (True, False, ...)
call s:InitVariable('g:python_syntax_builtin_objs', g:python_syntax_all)

" Highlight builtin types (str, list, ...)
call s:InitVariable('g:python_syntax_builtin_types', g:python_syntax_all)

" Highlight builtin types (div, eval, ...)
call s:InitVariable('g:python_syntax_builtin_funcs', g:python_syntax_all)

" Highlight exceptions (TypeError, ValueError, ...)
call s:InitVariable('g:python_syntax_highlight_exceptions', g:python_syntax_all)

" More slow synchronizing. Disable on the slow machine, but code in docstrings
" could be broken.
call s:InitVariable('g:python_syntax_slow_sync', 1)
